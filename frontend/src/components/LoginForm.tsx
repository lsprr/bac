...
const LoginForm: React.FunctionComponent<LoginFormProps> = ({ onSubmit, setLogin, setPassword, loading }) => {
    return (
        <form action="#" className="mt-8 grid grid-cols-6 gap-6" onSubmit={onSubmit}>
